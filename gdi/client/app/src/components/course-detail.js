      ...
      return (
        <div>
          ...
          <div className="course-detail">
              ...
              <div>
                <h3>Volunteers</h3>
                <p>GDI Coordinator: {this.props.course.coordinator.firstName} {this.props.course.coordinator.lastName}</p>
                <p>Instructor: {this.props.course.instructor.firstName} {this.props.course.instructor.lastName}</p>
                <p>Teaching Assistants: {this.props.course.tas[0].firstName} {this.props.course.tas[0].lastName}</p>
              </div>
