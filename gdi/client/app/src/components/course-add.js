          ...
          <form role="form" onSubmit={this.props.handleSubmit(values => this.onSubmit(values) )}>
            {/* <fieldset className="course-inputs"> */}
              ...
              <div>
                ...
                <Field component="select" type="text" name="coordinator" id="coordinator-name" >
                  <option>Select One...</option>
              ...
              <div>
                ...
                <Field component="select" type="text" name="instructor" id="instructor-name" >
                  <option>Select One...</option>
              ...
              <div>
                ...
                <Field component="select" type="text" name="venue" id="venue-name" >
                  <option>Select One...</option>
                  <option value="5a4d0643c1e8fa67e1151156">Digital Crafts</option>
                  <option value="5a4d0643c1e8fa67e1151158">CareerBuilder-Norcross Office</option>
                  <option value="5a4d0643c1e8fa67e115115a">CareerBuilder-Atlanta Office</option>
